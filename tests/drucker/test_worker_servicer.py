...
from tests.base import DruckerWorkerTest, patch_predictor, predictor, service_logger
...
class DruckerWorkerServicerTest(DruckerWorkerTest):
    ...
    def test_String_String(self):
        servicer = drucker.core.drucker_worker_servicer.DruckerWorkerServicer(logger=service_logger, predictor=predictor)
